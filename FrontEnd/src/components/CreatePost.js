  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 p-8">
      <div className="w-full md:w-1/2 bg-white p-4 border border-gray-300 rounded-md shadow">
        ...
        <label className="m-2 text-lg font-semibold text-gray-700">Title</label>
        <input
          type="text"
        ...
        />
        <label className="m-2 text-lg font-semibold text-gray-700">Slug</label>
        <input
          type="text"
        ...
        />
        <label className="m-2 text-lg font-semibold text-gray-700">Editor</label>
      ...
      <div className="w-full md:w-1/2 bg-gray-50 p-4 border border-gray-300 rounded-md shadow">
        ...
        <div className="prose max-w-none" id="previewshow" />
      </div>
    </div>
  );
};
